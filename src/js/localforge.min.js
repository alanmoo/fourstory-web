...
function(a, b) {
    if ("function" == typeof define && define.amd) define("localforageSerializer", ["exports", "module"], b);
    else if ("undefined" != typeof exports && "undefined" != typeof module) b(exports, module);
    else {
        var c = {
            exports: {}
        };
        b(c.exports, c), a.localforageSerializer = c.exports
    }
}(this, function(a, b) {
    "use strict";
    (function() {
        function a(a, b) {
            ...
            try {
                ...
                for (var d = x.BlobBuilder || x.MSBlobBuilder || x.MozBlobBuilder || x.WebKitBlobBuilder, e = new d, f = 0; f < a.length; f += 1) e.append(a[f]);
        ...
        function d(b) {
            if (b.substring(0, k) !== j) return JSON.parse(b);
            var c, d = b.substring(w),
                f = b.substring(k, w);
            if (f === m && i.test(d)) {
                var g = d.match(i);
...
function(a, b) {
    if ("function" == typeof define && define.amd) define("asyncStorage", ["exports", "module"], b);
    else if ("undefined" != typeof exports && "undefined" != typeof module) b(exports, module);
    else {
        var c = {
            exports: {}
        };
        b(c.exports, c), a.asyncStorage = c.exports
    }
}(this, function(a, b) {
    "use strict";
    (function() {
        ...
        function f(a) {
            return "boolean" == typeof u ? Promise.resolve(u) : e(a).then(function(a) {
                return u = a
            })
        }
        ...
        function m(a, b, c) {
            ...
            var e = new Promise(function(c, e) {
                ...
                d.ready().then(function() {
                    return h = d._dbInfo, f(h.db)
                }).then(function(a) {
                    return !a && b instanceof Blob ? g(b) : b
                }).then(function(b) {
                    var d = h.db.transaction(h.storeName, "readwrite"),
                        f = d.objectStore(h.storeName);
                    null === b && (b = void 0);
                    var g = f.put(b, a);
        ...
        var t = t || this.indexedDB || this.webkitIndexedDB || this.mozIndexedDB || this.OIndexedDB || this.msIndexedDB;
        if (t) {
            var u, v = "local-forage-detect-blob-support",
                w = {
...
function(a, b) {
    if ("function" == typeof define && define.amd) define("localStorageWrapper", ["exports", "module"], b);
    else if ("undefined" != typeof exports && "undefined" != typeof module) b(exports, module);
    else {
        var c = {
            exports: {}
        };
        b(c.exports, c), a.localStorageWrapper = c.exports
    }
}(this, function(a, b) {
    "use strict";
    (function() {
        function a(a) {
            ...
            return d.keyPrefix = d.name + "/", c._dbInfo = d, new Promise(function(a, c) {
                var d = window;
                "function" == typeof d.define && d.define.amd ? d.require(["localforageSerializer"], a, c) : a("undefined" != typeof b && b.exports && "undefined" != typeof require || "undefined" != typeof b && b.component && d.require && "component" === d.require.loader ? require("./../utils/serializer") : d.localforageSerializer)
            }).then(function(a) {
                return l = a, Promise.resolve()
            })
        }
        ...
        function d(a, b) {
            ...
            var d = c.ready().then(function() {
                var b = c._dbInfo,
                    d = m.getItem(b.keyPrefix + a);
                return d && (d = l.deserialize(d)), d
            });
            return k(d, b), d
        }
        ...
        function e(a, b) {
            var c = this,
                d = c.ready().then(function() {
                    for (var b = c._dbInfo.keyPrefix, d = b.length, e = m.length, f = 0; e > f; f++) {
                        var g = m.key(f),
                            h = m.getItem(g);
                        if (h && (h = l.deserialize(h)), h = a(h, g.substring(d), f + 1), void 0 !== h) return h
                    }
                });
            return k(d, b), d
        }
        ...
        function j(a, b, c) {
            ...
            var e = d.ready().then(function() {
                ...
                return new Promise(function(e, f) {
                    l.serialize(b, function(b, g) {
                        if (g) f(g);
                        else try {
                            var h = d._dbInfo;
                            m.setItem(h.keyPrefix + a, b), e(c)
                        } catch (i) {
...
function(a, b) {
    if ("function" == typeof define && define.amd) define("webSQLStorage", ["exports", "module"], b);
    else if ("undefined" != typeof exports && "undefined" != typeof module) b(exports, module);
    else {
        var c = {
            exports: {}
        };
        b(c.exports, c), a.webSQLStorage = c.exports
    }
}(this, function(a, b) {
    "use strict";
    (function() {
        function a(a) {
            ...
            var f = new Promise(function(b, e) {
                try {
                    ...
                    return c.setDriver(c.LOCALSTORAGE).then(function() {
                        return c._initStorage(a)
                    }).then(b)["catch"](e)
                }
                d.db.transaction(function(a) {
                    a.executeSql("CREATE TABLE IF NOT EXISTS " + d.storeName + " (id INTEGER PRIMARY KEY, key unique, value)", [], function() {
                        c._dbInfo = d, b()
                    }, function(a, b) {
                        e(b)
                    })
                        ...
                        e.db.transaction(function(c) {
                            c.executeSql("SELECT * FROM " + e.storeName, [], function(c, d) {
                                for (var e = d.rows, f = e.length, g = 0; f > g; g++) {
                                    var h = e.item(g),
                                        i = h.value;
                                    if (i && (i = l.deserialize(i)), i = a(i, h.key, g + 1), void 0 !== i) return void b(i)
                                }
                                b()
                            }, function(a, b) {
                                d(b)
...
function(a, b) {
    if ("function" == typeof define && define.amd) define("localforage", ["exports", "module"], b);
    else if ("undefined" != typeof exports && "undefined" != typeof module) b(exports, module);
    else {
        var c = {
            exports: {}
        };
        b(c.exports, c), a.localforage = c.exports
    }
}(this, function(a, b) {
    "use strict";
    ...
    function c(a, b) {
        ...
        var f = {}, g = {
            ...
            l = Array.isArray || function(a) {
                ...
                function h(b) {
                    c(this, h), this.INDEXEDDB = g.INDEXEDDB, this.LOCALSTORAGE = g.LOCALSTORAGE, this.WEBSQL = g.WEBSQL, this._config = d({}, j, b), this._driverSet = null, this._ready = !1, this._dbInfo = null;
                    for (var e = 0; e < i.length; e++) a(this, i[e]);
                    this.setDriver(this._config.driver)
                }
                return h.prototype.config = function(a) {
                    if ("object" == typeof a) {
                ...
                }, h.prototype.defineDriver = function(a, b, c) {
                    var d = new Promise(function(b, c) {
                        try {
                            var d = a._driver,
                                g = new Error("Custom driver not compliant; see https://mozilla.github.io/localForage/#definedriver"),
                                h = new Error("Custom driver name already in use: " + a._driver);
                            if (!a._driver) return void c(g);
                            if (e(a._driver)) return void c(h);
                            for (var j = i.concat("_initStorage"), l = 0; l < j.length; l++) {
                                var m = j[l];
                                if (!m || !a[m] || "function" != typeof a[m]) return void c(g)
                            }
                    ...
                    return c.then(a, a), c
                }, h.prototype.setDriver = function(a, c, d) {
                    function g() {
                        h._config.driver = h.driver()
                    }
                    var h = this;
                    return "string" == typeof a && (a = [a]), this._driverSet = new Promise(function(c, d) {
                        var g = h._getFirstSupportedDriver(a),
                            i = new Error("No available storage method found.");
                        if (!g) return h._driverSet = Promise.reject(i), void d(i);
                        if (h._dbInfo = null, h._ready = null, e(g)) {
                            var j;
                            switch (g) {
                                case h.INDEXEDDB:
                                    j = new Promise(function(a, c) {
                                        var d = window;
                                        "function" == typeof d.define && d.define.amd ? d.require(["asyncStorage"], a, c) : a("undefined" != typeof b && b.exports && "undefined" != typeof require || "undefined" != typeof b && b.component && d.require && "component" === d.require.loader ? require("./drivers/indexeddb") : d.asyncStorage)
                                    });
                                    break;
                                case h.LOCALSTORAGE:
                                    j = new Promise(function(a, c) {
                                        var d = window;
                                        "function" == typeof d.define && d.define.amd ? d.require(["localStorageWrapper"], a, c) : a("undefined" != typeof b && b.exports && "undefined" != typeof require || "undefined" != typeof b && b.component && d.require && "component" === d.require.loader ? require("./drivers/localstorage") : d.localStorageWrapper)
                                    });
                                    break;
                                case h.WEBSQL:
                                    j = new Promise(function(a, c) {
                                        var d = window;
                                        "function" == typeof d.define && d.define.amd ? d.require(["webSQLStorage"], a, c) : a("undefined" != typeof b && b.exports && "undefined" != typeof require || "undefined" != typeof b && b.component && d.require && "component" === d.require.loader ? require("./drivers/websql") : d.webSQLStorage)
                                    })
                            }
                            j.then(function(a) {
                                h._extend(a), c()
                            })
                        } else f[g] ? (h._extend(f[g]), c()) : (h._driverSet = Promise.reject(i), d(i))
                    }), this._driverSet.then(g, g), this._driverSet.then(c, d), this._driverSet
                }, h.prototype.supports = function(a) {
                    return !!k[a]
                }, h.prototype._extend = function(a) {
                    d(this, a)
                }, h.prototype._getFirstSupportedDriver = function(a) {
                    if (a && l(a))
                    ...
                    return null
                }, h.prototype.createInstance = function(a) {
                    return new h(a)
                }, h
            }(),
            n = new m;
